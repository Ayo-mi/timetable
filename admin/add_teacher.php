...
<td><input type = 'email' name = 'e' value = 'test@gmail.com' class = 'form-control' placeholder = 'enter your email'/></td>
</tr>

<tr>
<th scope = 'row'>Enter Your Password </th>
<td><input type = 'password' name = 'p' value = '12345678' class = 'form-control' placeholder = 'enter password'/></td>
</tr>

<tr>
<th scope = 'row'>Enter Your Mobile </th>
<td><input type = 'number' name = 'm' class = 'form-control' value="09099887766" placeholder = 'enter your mobile'/></td>
</tr>

<tr>
<th scope = 'row'>Enter Your Address</th>
<td><input type = 'text' name = 'a' class = 'form-control' value="PTI" placeholder = 'enter your address'/></td>
</tr>
